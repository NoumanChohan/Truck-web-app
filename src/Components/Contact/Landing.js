...
const Landing = () => {
    return (
        <div className='h-[85vh] xs:h-[77vh]  md:h-[60vh] w-full bg-[#F8F8F8]'>
            <div className=' h-[90%] w-full bg-[#0e1c3c] bg-cover bg-center flex justify-center items-center' style={{ backgroundImage: "url(http://webdesign-finder.com/tracktruck/wp-content/uploads/2021/06/texture3.png)" }}>
                ...
                <div className=' w-[90%] md:w-[70%] h-[55%]  md:mt-[10%]  flex flex-col justify-between items-center text-5xl font-bold font-sans-serif text-white'>
                    <span className='w-fit  h-fit'>Contacts</span>

                    <div className=' w-full h-[30%] flex   text-white  justify-around items-center '>
                    ...
                    <div className="w-[70%] h-[60px] xs:h-[80px] sm:h-[80px] sm:w-[50%] lg:w-[40%] xl:w-[30%]  bg-[#FDE344]  text-black text-xs sm:text-base md:text-base font-semibold 	flex justify-center items-center hover:scale-95 transform transition-all duration-200">
