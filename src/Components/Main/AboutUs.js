        ...
        <div className='w-full h-[70vh] bg-[#F8F8F8] flex '>
            <div className="h-[72%] w-[77%]  mt-[184px] ml-[207px]  flex justify-between">
                <div className="flex flex-col text-white  w-[70%] h-full">
                    ...
                    <span className="text-[64px]  w-[70%] h-[50%] tracking-wide	text-[#0E1C3C] leading-[1.2] font-semibold	mt-4">Streamline Your Dispatching Process with Track-Truck</span>
                    ...
                    <p className="text-[#81899c]  mt-6 leading-[1.8] tracking-tight font-[400] text-left">We are your reliable partner in trucking and dispatching. Our experienced team simplifies the process, ensuring efficiency and profitability. With cutting-edge technology and personalized solutions, we optimize your operations, save you time and money, and enhance productivity. Join us today and revolutionize your dispatching process.</p>
                </div>
