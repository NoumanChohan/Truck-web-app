...
const Careers = () => {
    return (
        <div className='w-full h-[350vh] bg-[#d01d1d] flex flex-col justify-between items-center'>
            <div className=' h-[7%] w-[90%]  bg-green-300 flex flex-col justify-between  '>
            ...
            <div className='w-full h-[90%] bg-pink-400  mt-[10%] flex flex-col justify-around '>
                ...
                <div className='w-full h-[20%] bg-yellow-200 flex flex-col items-center '>
                    <div className='w-[55%] h-[45%]  rounded-full bg-[#F8F8F8] shadow-md flex bg-cover bg-center items-center justify-center '><img className='w-[90%] h-[90%] hover:scale-110 transition-transform' src='/Images/career-1.png'></img></div>
                    <div className='h-[55%] w-[90%] ml-4 bg-green-300 flex flex-col items-center'>

                        <button className="tracking-normal flex  w-[90%] h-fit mt-[5%] bg-pink-300">
                            <span className="text-xl leading-[1.2em] text-black  font-bold h-fit w-fit">Dispatch Coordinator</span>
