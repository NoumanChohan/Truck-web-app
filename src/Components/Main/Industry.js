...
const Industry = () => {
    return (
        <div className="w-full h-[160vh] i5:h-[200vh] flex flex-col items-center justify-between bg-yellow-200  ">

            <div className="flex  flex-col h-[21%] i5:h-[22%] xs:h-[19%] w-[90%] mt-[20%] bg-green-200 ">
