...
const Industry = () => {
    return (
        <div className="w-full h-[200vh] flex flex-col items-center justify-between bg-yellow-200  ">

            <div className="flex  flex-col h-[20%] w-[90%] mt-[20%] bg-green-200 ">
            ...
            <div className="w-full h-[65%] bg-[#0e1c3c] bg-cover bg-center  flex flex-col " style={{ backgroundImage: 'url(http://webdesign-finder.com/tracktruck/wp-content/uploads/2021/06/texture3.png)' }}>
