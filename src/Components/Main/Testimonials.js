    ...
    return (
        <>
            <div className="w-full h-[350vh] i5:h-[400vh] xs:h-[280vh] flex flex-col bg-red-400 items-center justify-between">
                <div className="h-[13%] i5:h-[12%] xs:h-[11%] w-[90%]  mt-[20%] md:mt-[15%]  bg-green-200 flex flex-col ">
                    <p className="tracking-[.2em] w-fit h-fit  text-base text-[#81899c]">TESTIMONIALS</p>
                    <span className="text-5xl i5:text-3xl  xs:text-4xl  w-fit md:w-[55%] h-fit bg-pink-300 tracking-tight	text-[#0E1C3C] leading-[1] font-semibold xs:font-bold 	mt-[5%]">What our happy clients say</span>


                    <div className="flex  h-fit w-[85%] i5:w-[70%] xs:w-[70%] md:w-[35%] md:mt-[5%] mt-[20%] i5:mt-[10%] xs:mt-auto items-center">
