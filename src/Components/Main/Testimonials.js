    ...
    return (
        <>
            <div className="w-full h-[350vh] i5:h-[400vh] xs:h-[280vh] flex flex-col bg-red-400 items-center justify-between">
                <div className="h-[13%] i5:h-[11%] xs:h-[11%] w-[90%]  mt-[20%]  bg-green-200 flex flex-col ">
                    ...
                    <div className="flex  h-fit w-[85%] i5:w-[70%] xs:w-[70%] mt-[20%] i5:mt-auto xs:mt-auto items-center">
